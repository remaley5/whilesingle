...
def all_fr_questions():
    ...
    return {'all_fr_questions': [question.to_dict() for question in fr_questions]}


@fr_routes.route('/responses/<int:user_id>')
def answered_fr_questions(user_id):
    ...
    return {'fr_responses': [fr_response.to_dict() for fr_response in fr_responses]}
...
def unanswered_fr_questions(user_id):
    ...
    return {'unanswered_fr_questions': [question.to_dict() for question in unanswered_fr_questions]}
